  ...
  ({ className, ...props }, ref) => (
    <div className="relative w-full overflow-auto">
      <table
        ref={ref}
        className={cn(
          // base: compact for small screens, expand slightly on md and up
          "w-full caption-bottom text-xs md:text-sm",
          className,
        )}
        {...props}
      />
...
const TableHead = React.forwardRef<HTMLTableCellElement, React.ThHTMLAttributes<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => (
    <th
      ref={ref}
      className={cn(
        // compact padding/height on small screens, larger on md and up
